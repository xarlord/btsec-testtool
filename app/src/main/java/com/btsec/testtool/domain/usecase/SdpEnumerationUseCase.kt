        ...
        fun generateScanReport(result: SdpScanResult): String {
            ...
            if (result.services.isNotEmpty()) {
                ...
                for (service in result.services) {
                    ...
                    sb.appendLine(
                        "    Auth: ${service.requiresAuthentication ?: "unknown"}, Enc: ${service.requiresEncryption ?: "unknown"}",
                    )
                }
                sb.appendLine()
            }
