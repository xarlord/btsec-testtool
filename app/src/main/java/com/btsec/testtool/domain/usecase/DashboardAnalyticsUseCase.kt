 ...
 */
@Singleton
class DashboardAnalyticsUseCase @Inject constructor() {
    ...
    fun computeSummary(scans: List<ScanRecord>): ScanSummary {
        ...
        return ScanSummary(
            ...
            totalVulnerabilities = scans.sumOf {
            ...
            averageRiskScore = computeOverallRiskScore(
                ScanSummary(
                    totalScans = scans.size,
                    totalDevices = uniqueDevices.size,
                    totalVulnerabilities = scans.sumOf {
     ...
     */
    fun computeTrends(scans: List<ScanRecord>, timeRange: TimeRange): List<VulnerabilityTrend> {
    ...
    fun computeOverallRiskScore(summary: ScanSummary): Double {
        ...
        val weighted = summary.criticalCount * 100L +
