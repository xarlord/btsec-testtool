...
class PacketCaptureUseCase @Inject constructor() {
     ...
     */
    fun filterPackets(packets: List<CapturedPacket>, filter: PacketFilter): List<CapturedPacket> {
        return packets.filter { packet ->
            ...
            val searchMatch = filter.searchQuery.isNullOrBlank() || run {
     ...
     */
    fun formatHexRow(data: ByteArray, bytesPerRow: Int = 16): List<String> {
