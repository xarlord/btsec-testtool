 ...
 */
class HexDumpUseCase @Inject constructor() {
     ...
     */
    fun searchInDump(entries: List<HexDumpEntry>, query: String): List<HexDumpEntry> {
    ...
    private fun formatHexBytes(lineBytes: ByteArray, bytesPerLine: Int): String {
        val sb = StringBuilder()
