 ...
 */
@Singleton
class ScriptingDslUseCase @Inject constructor() {
    ...
    companion object {
        ...
        private val REQUIRES_CONNECTION = setOf(
            ScriptStepType.READ,
     ...
     */
    fun resolveVariable(value: String, variables: Map<String, String>): String {
     ...
     */
    fun createStep(type: ScriptStepType, params: Map<String, String>): ScriptStep {
