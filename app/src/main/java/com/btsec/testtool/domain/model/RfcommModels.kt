...
data class RfcommChannel(
    val channelNumber: Int,      // 1-30
    val serviceName: String,
    val uuid: String,
    val profileName: String,     // e.g. "HFP", "SPP", "DUN"
...
data class AtCommand(
    val command: String,         // e.g. "ATD", "ATA", "ATH"
    val description: String,
    val category: AtCommandCategory,
    val risk: SecurityRisk,
    val parameters: String = "", // e.g. "+1234567890;" for ATD
    val expectedResponse: String = ""  // e.g. "OK", "ERROR", "RING"
)
