    ...
    constructor(
        ...
        override fun getReportsSummary(): Flow<ReportsSummary> {
            return flow {
                ...
                // Single-pass iteration to prevent intermediate object allocations and redundant iterations (O(N) instead of O(N*M))
                var draftReports = 0
                var finalReports = 0
                var criticalVulnerabilitiesTotal = 0
                var highVulnerabilitiesTotal = 0
                ...
                allReports.forEach { report ->
                    ...
                    report.vulnerabilities.forEach { vulnerability ->
                        if (vulnerability.severity == VulnerabilitySeverity.CRITICAL) criticalVulnerabilitiesTotal++
                        if (vulnerability.severity == VulnerabilitySeverity.HIGH) highVulnerabilitiesTotal++
                    }
                }
                ...
                emit(
                    ReportsSummary(
                        ...
                        criticalVulnerabilitiesTotal = criticalVulnerabilitiesTotal,
                        highVulnerabilitiesTotal = highVulnerabilitiesTotal,
                        pendingActions = 0,
                    ),
                )
            }
