 ...
 */
@Singleton
class SapSecurityRepositoryImpl @Inject constructor(
    ...
    override suspend fun sendApdu(apdu: SimApdu, timeoutMs: Long): ByteArray? {
     ...
     */
    private fun buildSapMessage(msgCode: Int, payload: ByteArray): ByteArray {
