    ...
    constructor(
        ...
        override fun getFuzzingStatistics(): Flow<FuzzingStatistics> {
            return flow {
                ...
                // Optimization: Single-pass iteration to compute all statistics.
                // Eliminates 7 redundant iterations (sumOf x4, minByOrNull, maxByOrNull, map/average)
                // and avoids intermediate list allocations.
        ...
        override suspend fun getStatisticsForDevice(deviceAddress: String): DeviceFuzzingStatistics {
            ...
            // Optimization: Single-pass iteration to compute device statistics.
            // Replaces multiple sequential terminal operations with a single loop.
            var packetsSent = 0L
