...
class AuthorizationBackend
    ...
    constructor(
        ...
        private fun verifyDemoAuthorization(authId: String): Authorization {
            ...
            val scope =
                TestScope(
                    ...
                    validFrom = now,
                    // 4 hours — intentionally short for demo
                    validUntil = now.plusSeconds(14400),
                    // Restricted rate for demo mode
         ...
         */
        internal suspend fun performServerVerification(
            authId: String,
            serverUrl: String,
        ): Authorization? =
         ...
         */
        internal fun parseServerResponse(
            authId: String,
            json: String,
        ): Authorization? {
            try {
