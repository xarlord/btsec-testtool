 ...
 */
@Singleton
class L2capSecurityRepositoryImpl @Inject constructor(
    ...
    override suspend fun queryInformation(deviceAddress: String, infoType: Int): ByteArray? {
