...
class ConnectFlowE2ETest {
    ...
    @Test
    fun connectFlow_initialState_disconnected() =
        runBlocking {
    ...
    @Test
    fun connectFlow_noDeviceConnectedInitially() =
        runBlocking {
    ...
    @Test
    fun connectFlow_readCharFailsWhenNotConnected() =
        runBlocking {
    ...
    @Test
    fun connectFlow_writeCharFailsWhenNotConnected() =
        runBlocking {
            val result =
    ...
    @Test
    fun connectFlow_readDescriptorFailsWhenNotConnected() =
        runBlocking {
            val result =
                bluetoothRepository.readDescriptor(
                    testServiceUuid,
                    testCharUuid,
                    testDescriptorUuid,
                )
    ...
    @Test
    fun connectFlow_writeDescriptorFailsWhenNotConnected() =
        runBlocking {
            val result =
                bluetoothRepository.writeDescriptor(
                    testServiceUuid,
                    testCharUuid,
                    testDescriptorUuid,
    ...
    @Test
    fun connectFlow_discoverServicesEmptyWhenNotConnected() =
        runBlocking {
    ...
    @Test
    fun connectFlow_getServicesEmptyWhenNotConnected() =
        runBlocking {
    ...
    @Test
    fun connectFlow_defaultMtuIs23() =
        runBlocking {
    ...
    @Test
    fun connectFlow_requestMtuFailsWhenNotConnected() =
        runBlocking {
    ...
    @Test
    fun connectFlow_readRssiFailsWhenNotConnected() =
        runBlocking {
    ...
    @Test
    fun connectFlow_refreshCacheFailsWhenNotConnected() =
        runBlocking {
    ...
    @Test
    fun connectFlow_subscribeUnsubscribeContract() =
        runBlocking {
            val unsubResult =
                bluetoothRepository.unsubscribeFromCharacteristic(
                    testServiceUuid,
                    testCharUuid,
                )
    ...
    @Test
    fun connectFlow_disconnectIsIdempotent() =
        runBlocking {
    ...
    @Test
    fun connectFlow_bondStateObservableForUnknownDevice() =
        runBlocking {
    ...
    @Test
    fun connectFlow_selectDeviceBeforeConnect() =
        runBlocking {
    ...
    @Test
    fun connectFlow_packetMonitoringAvailabilityCheck() =
        runBlocking {
