...
class FuzzFlowE2ETest {
    ...
    @Test
    fun fuzzFlow_fuzzingStatusObservable() =
        runBlocking {
    ...
    @Test
    fun fuzzFlow_fuzzingProgressInitiallyNull() =
        runBlocking {
    ...
    @Test
    fun fuzzFlow_allFuzzingResultsObservable() =
        runBlocking {
    ...
    @Test
    fun fuzzFlow_fuzzingStatisticsObservable() =
        runBlocking {
    ...
    @Test
    fun fuzzFlow_fuzzingLogsInitiallyEmpty() =
        runBlocking {
