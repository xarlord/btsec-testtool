...
class SdpEnumerationRepositoryImplTest {
    ...
    @Test
    fun `browseServices returns empty for device with no UUIDs`() =
        runTest {
            every { bluetoothAdapter.getRemoteDevice(any<String>()) } returns bluetoothDevice
    ...
    @Test
    fun `getCachedScanResult returns null for non-existent device`() =
        runTest {
    ...
    @Test
    fun `saveScanResult persists and retrieves scan result`() =
        runTest {
            val scanResult =
                SdpScanResult(
    ...
    @Test
    fun `getAllScanResults returns empty initially`() =
        runTest {
    ...
    @Test
    fun `getAllScanResults returns all saved scan results`() =
        runTest {
            val scanResult1 =
                SdpScanResult(
                    deviceAddress = "00:11:22:33:44:55",
    ...
    @Test
    fun `deleteScanResult removes cached result`() =
        runTest {
            val scanResult =
                SdpScanResult(
                    deviceAddress = "00:11:22:33:44:55",
            ...
            assertNull(repository.getCachedScanResult("00:11:22:33:44:55"))
        }

    @Test
    fun `isBrowsing initially false`() =
        runTest {
            assertFalse(repository.isBrowsing().first())
        }

    @Test
    fun `isBrowsing false after browseServices completes`() =
        runTest {
            every { bluetoothAdapter.getRemoteDevice(any<String>()) } returns bluetoothDevice
    ...
    @Test
    fun `browseServices handles null device gracefully`() =
        runTest {
    ...
    @Test
    fun `saveScanResult overwrites existing result for same device`() =
        runTest {
            val scanResult1 =
                SdpScanResult(
                    deviceAddress = "00:11:22:33:44:55",
