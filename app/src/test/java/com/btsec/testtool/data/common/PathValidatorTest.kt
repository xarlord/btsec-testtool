...
class PathValidatorTest {
    ...
    fun pathValidation_allowsTempDirPath(@TempDir tempDir: File) {
        ...
        val isAllowed = allowedDirs.any { base ->
    ...
    fun pathValidation_rejectsPathOutsideAllowedDirs(@TempDir tempDir: File) {
        val allowedDirs = listOf(tempDir.canonicalPath)
    ...
    fun pathValidation_rejectsTraversalEscape(@TempDir tempDir: File) {
    ...
    fun pathValidation_handlesDotDotWithinAllowedDir(@TempDir tempDir: File) {
    ...
    fun pathValidation_exactBaseDirMatch(@TempDir tempDir: File) {
        val allowedDirs = listOf(tempDir.canonicalPath)
    ...
    fun pathValidation_subdirectoryAllowed(@TempDir tempDir: File) {
    ...
    fun pathValidation_siblingDirRejected(@TempDir tempDir: File) {
    ...
    fun pathValidation_deepNestingAllowed(@TempDir tempDir: File) {
        val allowedDirs = listOf(tempDir.canonicalPath)
    ...
    fun pathValidation_matchesSecondAllowedDir(@TempDir tempDir: File) {
    ...
    fun pathValidation_deepTraversalRejected(@TempDir tempDir: File) {
        val allowedDirs = listOf(tempDir.canonicalPath)
    ...
    fun pathValidation_separatorPreventsPartialMatch(@TempDir tempDir: File) {
