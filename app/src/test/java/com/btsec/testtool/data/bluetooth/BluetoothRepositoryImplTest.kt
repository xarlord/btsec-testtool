...
class BluetoothRepositoryImplTest {
    ...
    inner class BluetoothStateTests {
        ...
        fun bluetoothEnabledReturnsTrue() =
            runTest {
                every { bluetoothAdapter.isEnabled } returns true
        ...
        fun bluetoothDisabledReturnsFalse() =
            runTest {
        ...
        fun requestEnableReturnsFalseWhenDisabled() =
            runTest {
                every { bluetoothAdapter.isEnabled } returns false
        ...
        fun requestEnableReturnsTrueWhenEnabled() =
            runTest {
                every { bluetoothAdapter.isEnabled } returns true
                val result = repository.requestEnableBluetooth()
                assertTrue(result)
    ...
    inner class DeviceManagementTests {
        ...
        fun getDeviceReturnsNullWhenEmpty() =
            runTest {
        ...
        fun clearDeviceCacheEmptiesResults() =
            runTest {
        ...
        fun cachedDevicesReturnsScanResults() =
            runTest {
    ...
    inner class ConnectionStateTests {
        ...
        fun noConnectedDeviceInitially() =
            runTest {
    ...
    inner class GattOperationsTests {
        ...
        fun writeFailsWhenNotConnected() =
            runTest {
                val result =
                    repository.writeCharacteristic(
                        testServiceUuid,
        ...
        fun readDescriptorFailsWhenNotConnected() =
            runTest {
                val result =
                    repository.readDescriptor(
                        testServiceUuid,
                        testCharacteristicUuid,
                        testDescriptorUuid,
                    )
        ...
        fun writeDescriptorFailsWhenNotConnected() =
            runTest {
                val result =
                    repository.writeDescriptor(
                        testServiceUuid,
                        testCharacteristicUuid,
                        testDescriptorUuid,
                        byteArrayOf(0x01),
        ...
        fun discoverServicesEmptyInitially() =
            runTest {
    ...
    inner class MtuRssiTests {
        ...
        fun requestMtuFailsWhenNotConnected() =
            runTest {
        ...
        fun readRssiFailsWhenNotConnected() =
            runTest {
        ...
        fun requestConnectionPriorityFailsWhenNotConnected() =
            runTest {
    ...
    inner class BondingTests {
        ...
        fun createBondReturnsFalseOnNullAdapter() =
            runTest {
        ...
        fun removeBondReturnsFalseOnNullAdapter() =
            runTest {
                val nullAdapterManager = mockk<BluetoothManager>()
                every { nullAdapterManager.adapter } returns null
                every { context.getSystemService(Context.BLUETOOTH_SERVICE) } returns nullAdapterManager
    ...
    inner class PacketMonitoringTests {
        ...
        fun monitoringNotAvailableWhenNoSnoopLog() =
            runTest {
        ...
        fun packetStatsZeroedWhenNoSnoopLog() =
            runTest {
        ...
        fun stopMonitoringDoesNotCrash() =
            runTest {
        ...
        fun startMonitoringEmitsNothingWithoutSnoopLog() =
            runTest {
    ...
    inner class LoggingTests {
        ...
        fun logOperationHandlesDaoError() =
            runTest {
        ...
        fun getOperationLogsReturnsMappedFlow() =
            runTest {
    ...
    inner class CacheRefreshTests {
        ...
        fun refreshCacheFailsWhenNotConnected() =
            runTest {
    ...
    inner class UnsubscribeTests {
        ...
        fun unsubscribeFailsWhenNotConnected() =
            runTest {
                val result =
                    repository.unsubscribeFromCharacteristic(
                        testServiceUuid,
                        testCharacteristicUuid,
                    )
                assertTrue(result.isFailure)
