...
class ReportRepositoryImplTest {
    ...
    @Test
    fun `saveReport returns success on successful insert`() =
        runTest {
    ...
    @Test
    fun `saveReport returns failure on DAO exception`() =
        runTest {
    ...
    @Test
    fun `getReportById returns mapped report when found`() =
        runTest {
    ...
    @Test
    fun `getReportById returns null when not found`() =
        runTest {
    ...
    @Test
    fun `getReportById returns null on DAO exception`() =
        runTest {
    ...
    @Test
    fun `deleteReport returns success on successful delete`() =
        runTest {
    ...
    @Test
    fun `deleteReport returns failure on DAO exception`() =
        runTest {
    ...
    @Test
    fun `archiveReport returns success and updates status`() =
        runTest {
    ...
    @Test
    fun `archiveReport returns failure on DAO exception`() =
        runTest {
    ...
    @Test
    fun `generateSummaryReport returns success with report`() =
        runTest {
    ...
    @Test
    fun `generateSummaryReport with deviceAddress returns report`() =
        runTest {
    ...
    @Test
    fun `generateVulnerabilityReport maps vulnerabilities to target devices`() =
        runTest {
            val device =
                BluetoothDevice(
    ...
    @Test
    fun `generateFuzzingReport maps fuzzing results to report`() =
        runTest {
            val device =
                BluetoothDevice(
                    address = "AA:BB:CC:DD:EE:FF", name = "Test", type = BluetoothType.BLE,
    ...
    @Test
    fun `getAllReports returns mapped reports from DAO`() =
        runTest {
            val entity = mockk<SecurityReportEntity>(relaxed = true)
    ...
    @Test
    fun `getReportsByAuthId returns filtered reports`() =
        runTest {
            val entity = mockk<SecurityReportEntity>(relaxed = true)
            every { entity.authId } returns "AUTH-001"
    ...
    @Test
    fun `getReportsByStatus queries DAO with status name`() =
        runTest {
            val entity = mockk<SecurityReportEntity>(relaxed = true)
    ...
    @Test
    fun `uploadReport returns success with upload id`() =
        runTest {
    ...
    @Test
    fun `shareReport returns success`() =
        runTest {
    ...
    @Test
    fun `createTemplate and getTemplate round-trip`() =
        runTest {
            val template =
                ReportTemplate(
    ...
    @Test
    fun `updateTemplate replaces existing template`() =
        runTest {
            val template =
                ReportTemplate(
    ...
    @Test
    fun `deleteTemplate removes template`() =
        runTest {
            val template =
                ReportTemplate(
    ...
    @Test
    fun `getAvailableTemplates returns empty initially`() =
        runTest {
    ...
    @Test
    fun `logReportOperation appends to logs`() =
        runTest {
            val operation =
                ReportOperation(
                    id = "op-1",
    ...
    @Test
    fun `getReportsSummary computes dashboard summary`() =
        runTest {
            val entity = mockk<SecurityReportEntity>(relaxed = true)
            every { reportDao.getAllReports() } returns flowOf(listOf(entity))
    ...
    @Test
    fun `exportToJson returns failure when report not found`() =
        runTest {
            coEvery { reportDao.getReportById("nonexistent") } returns null
