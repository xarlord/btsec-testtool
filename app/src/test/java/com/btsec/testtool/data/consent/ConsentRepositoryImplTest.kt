...
class ConsentRepositoryImplTest {
    ...
    @Test
    fun `requestConsent inserts record and returns ConsentRecord`() =
        runTest {
    ...
    @Test
    fun `requestConsent returns null when DAO throws`() =
        runTest {
    ...
    @Test
    fun `requestConsentWithContext delegates to requestConsent`() =
        runTest {
            coEvery { consentDao.insertConsentRecord(any()) } just Runs
    ...
    @Test
    fun `hasConsent returns true when DAO confirms consent exists`() =
        runTest {
    ...
    @Test
    fun `hasConsent returns false when no consent exists`() =
        runTest {
    ...
    @Test
    fun `hasConsent returns false on DAO exception`() =
        runTest {
    ...
    @Test
    fun `getLatestConsent returns mapped domain record`() =
        runTest {
            val entity =
                ConsentRecordEntity(
                    id = "rec-1",
    ...
    @Test
    fun `getLatestConsent returns null when no record found`() =
        runTest {
    ...
    @Test
    fun `getLatestConsent returns null on DAO exception`() =
        runTest {
    ...
    @Test
    fun `saveConsentRecord returns success on valid insert`() =
        runTest {
            coEvery { consentDao.insertConsentRecord(any()) } just Runs
    ...
    @Test
    fun `saveConsentRecord returns failure on DAO exception`() =
        runTest {
            coEvery { consentDao.insertConsentRecord(any()) } throws RuntimeException("DB error")
    ...
    @Test
    fun `revokeConsent returns success when DAO deletes`() =
        runTest {
    ...
    @Test
    fun `revokeConsent returns failure on DAO exception`() =
        runTest {
    ...
    @Test
    fun `revokeAllConsent returns success`() =
        runTest {
            coEvery { consentDao.deleteConsentsByAuthId("AUTH-001") } just Runs
    ...
    @Test
    fun `deleteOldConsents returns deleted count on success`() =
        runTest {
    ...
    @Test
    fun `deleteOldConsents returns failure on DAO exception`() =
        runTest {
    ...
    @Test
    fun `logAuditEvent returns success and inserts audit log`() =
        runTest {
    ...
    @Test
    fun `logAuditEvent returns failure on DAO exception`() =
        runTest {
    ...
    @Test
    fun `getConsentRecords returns mapped flow from DAO`() =
        runTest {
            val entities =
                listOf(
                    ConsentRecordEntity(
    ...
    @Test
    fun `getConsentStatus maps all TestActions with consent state`() =
        runTest {
            val entities =
                listOf(
                    ConsentRecordEntity(
    ...
    @Test
    fun `getAuditStatistics returns computed statistics`() =
        runTest {
    ...
    @Test
    fun `getAuditStatistics returns zeros on DAO exception`() =
        runTest {
    ...
    @Test
    fun `getStatisticsForAuth returns computed auth stats`() =
        runTest {
    ...
    @Test
    fun `getStatisticsForAuth returns zeros on DAO exception`() =
        runTest {
            coEvery { consentDao.getAuditLogCount() } throws RuntimeException("DB error")
    ...
    @Test
    fun `generateComplianceReport returns report with DAO counts`() =
        runTest {
    ...
    @Test
    fun `generateComplianceReport returns empty report on DAO exception`() =
        runTest {
    ...
    @Test
    fun `getMostCommonOperations returns sorted operation counts`() =
        runTest {
            val entities =
                listOf(
                    AuditLogEntity(
    ...
    @Test
    fun `getOperationSuccessRate computes correct rate`() =
        runTest {
            val entities =
                listOf(
                    AuditLogEntity(
    ...
    @Test
    fun `getOperationSuccessRate returns 0 when no logs`() =
        runTest {
    ...
    @Test
    fun `getRecordsEligibleForDeletion returns 0 on success`() =
        runTest {
    ...
    @Test
    fun `getRecordsEligibleForDeletion returns 0 on exception`() =
        runTest {
            coEvery { consentDao.deleteConsentsOlderThan(any()) } throws RuntimeException("DB error")
    ...
    @Test
    fun `getDataRetentionSummary computes age buckets`() =
        runTest {
            val recentRecord =
                ConsentRecordEntity(
                    id = "recent",
