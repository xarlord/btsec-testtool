...
class ConsentRepositoryImplTest {
    ...
    fun testRequestConsentGranted() = runTest {
        val consent = repository.requestConsent(
            authId = "BTSEC-TEST",
    ...
    fun testRequestConsentWithContext() = runTest {
        val consent = repository.requestConsentWithContext(
            authId = "BTSEC-TEST",
    ...
    fun testHasConsentTrue() = runTest {
    ...
    fun testHasConsentFalse() = runTest {
    ...
    fun testGetConsentStatus() = runTest {
        repository.requestConsent(
            authId = "BTSEC-TEST",
            action = TestAction.SCAN_DEVICES,
            deviceInfo = testDeviceInfo
    ...
    fun testGetLatestConsent() = runTest {
        repository.requestConsent(
            authId = "BTSEC-TEST",
            action = TestAction.SCAN_DEVICES,
            deviceInfo = testDeviceInfo
    ...
    fun testGetConsentRecords() = runTest {
        repository.requestConsent(
            authId = "BTSEC-TEST",
            action = TestAction.SCAN_DEVICES,
            deviceInfo = testDeviceInfo
    ...
    fun testGetConsentRecordsInRange() = runTest {
        val now = Instant.now()
        ...
        val records = repository.getConsentRecordsInRange(
    ...
    fun testGetAllConsentRecords() = runTest {
        repository.requestConsent(
            authId = "BTSEC-TEST",
            action = TestAction.SCAN_DEVICES,
            deviceInfo = testDeviceInfo
    ...
    fun testGetDeniedConsents() = runTest {
    ...
    fun testGetConsentsByAction() = runTest {
        repository.requestConsent(
            authId = "BTSEC-TEST",
            action = TestAction.SCAN_DEVICES,
            deviceInfo = testDeviceInfo
    ...
    fun testSaveConsentRecord() = runTest {
    ...
    fun testRevokeAllConsent() = runTest {
        repository.requestConsent(
            authId = "BTSEC-TEST",
            action = TestAction.SCAN_DEVICES,
            deviceInfo = testDeviceInfo
    ...
    fun testGetAuditLogInRange() = runTest {
        val now = Instant.now()
        ...
        val logs = repository.getAuditLogInRange(
            start = now.minusSeconds(3600),
            end = now.plusSeconds(3600)
        ).first()
    ...
    fun testGetAuditLogByOperation() = runTest {
        repository.logAuditEvent(
            authId = "BTSEC-TEST",
            operation = "SCAN_DEVICES",
            deviceInfo = testDeviceInfo,
    ...
    fun testGetAllAuditLogs() = runTest {
        repository.logAuditEvent(
            authId = "BTSEC-TEST",
            operation = "TEST",
            deviceInfo = testDeviceInfo,
    ...
    fun testGetAuditStatistics() = runTest {
        repository.logAuditEvent(
            authId = "BTSEC-TEST",
            operation = "TEST_OP",
            deviceInfo = testDeviceInfo,
    ...
    fun testGetStatisticsForAuth() = runTest {
        repository.logAuditEvent(
            authId = "BTSEC-STATS",
            operation = "TEST",
            deviceInfo = testDeviceInfo,
    ...
    fun testGetMostCommonOperations() = runTest {
        repository.logAuditEvent(
            authId = "BTSEC-TEST",
            operation = "SCAN_DEVICES",
            deviceInfo = testDeviceInfo,
    ...
    fun testGetOperationSuccessRate() = runTest {
        repository.logAuditEvent(
            authId = "BTSEC-TEST",
    ...
    fun testGetDataRetentionSummary() = runTest {
        repository.requestConsent(
            authId = "BTSEC-TEST",
            action = TestAction.SCAN_DEVICES,
            deviceInfo = testDeviceInfo
    ...
    fun testGenerateComplianceReport() = runTest {
        val now = Instant.now()
    ...
    fun testDeleteOldConsents() = runTest {
