...
class FuzzingRepositoryImplTest {
    ...
    inner class LifecycleTests {
        ...
        fun startFuzzingEmitsProgress() = runTest {
            val engineResult = createEngineResult(
                packetsSent = 50,
                packetsReceived = 48,
                findings = listOf(
                    FuzzFinding(
    ...
    inner class PatternTests {
        ...
        fun getPatternsForType() = runTest {
        ...
        fun predefinedPatterns() = runTest {
    ...
    inner class StatisticsTests {
        ...
        fun fuzzingStatistics() = runTest {
            val r1 = createResult(
                ...
                findings = listOf(
                    FuzzFinding(
                        timestamp = Instant.now(), packetNumber = 1,
                        description = "crash", severity = VulnerabilitySeverity.HIGH,
                        packetData = null, response = null,
                        category = FindingCategory.CRASH
                    )
                )
            )
            val r2 = createResult(
                ...
                errors = listOf(
                    FuzzError(
                        timestamp = Instant.now(), packetNumber = 2,
                        errorCode = null, errorMessage = "err",
    ...
    inner class FindingsTests {
        ...
        fun findingsReturnEmpty() = runTest {
