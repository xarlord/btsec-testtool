...
class KeyExtractionRepositoryImplTest {
    ...
    inner class KnobAttackTests {
        ...
        fun testExtractKey_knobVulnerable() =
            runTest {
                ...
                val progressList =
                    repository.extractKey(
                        testDevice,
                        KeyType.LTK,
                        ExtractionMethod.ACTIVE_PROMPT,
        ...
        fun testExtractKey_knobSafe() =
            runTest {
                // All key sizes rejected (safe device)
                val safeProbe =
                    TestProbe(
                        // defaults to Rejected for all
                        negotiationResults = emptyMap(),
                        encryptionInfo =
                            EncryptionInfo(
                                keySize = 16,
        ...
        fun testExtractKey_unavailable() =
            runTest {
                // Platform cannot probe
                val unavailableProbe =
                    TestProbe(
                ...
                repository.extractKey(
                    testDevice,
                    KeyType.LTK,
                    ExtractionMethod.PASSIVE_MONITORING,
                ).first { it.status == ExtractionStatus.COMPLETED }
        ...
        fun testExtractKey_existingEncryption() =
            runTest {
        ...
        fun testExtractKey_knobVulnerable3Byte() =
            runTest {
        ...
        fun testExtractKey_negotiationError() =
            runTest {
                val errorProbe =
                    TestProbe(
    ...
    inner class KeyAnalysisTests {
        ...
        fun analyzeKeySecurityUnbonded() =
            runTest {
    ...
    inner class EncryptionAnalysisTests {
        ...
        fun supportsSecureConnectionsNoAdapter() =
            runTest {
        ...
        fun encryptionKeySizeNoAdapter() =
            runTest {
