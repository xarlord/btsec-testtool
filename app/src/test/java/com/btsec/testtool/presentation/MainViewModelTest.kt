...
class MainViewModelTest {
    ...
    fun testOnPermissionResultGranted() =
        runTest {
    ...
    fun testOnPermissionResultDenied() =
        runTest {
    ...
    fun testMultiplePermissionGrants() =
        runTest {
    ...
    fun testPermissionStatePersists() =
        runTest {
            viewModel.onPermissionResult(true)
            viewModel.setLoading(true)
            viewModel.setLoading(false)
    ...
    fun testLoadingStateIndependent() =
        runTest {
            viewModel.onPermissionResult(true)
            viewModel.setLoading(true)
            viewModel.onPermissionResult(false)
    ...
    fun testIndependentStateChanges() =
        runTest {
            assertFalse(viewModel.hasRequiredPermissions.value)
            assertFalse(viewModel.isLoading.value)
    ...
    fun testInitialPermissionState() =
        runTest {
            assertFalse(viewModel.hasRequiredPermissions.value)
        }
    ...
    fun testPermissionGrantedThenDenied() =
        runTest {
            viewModel.onPermissionResult(true)
            assertTrue(viewModel.hasRequiredPermissions.value)
            viewModel.onPermissionResult(false)
